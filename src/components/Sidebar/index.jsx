        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        key: "1-10-1",
                        label: <Link href={`/information/dm`}>Информация</Link>,
                    },
                    {
                        key: "1-10-2",
                    ...
                    {
                        key: "1-10-3",
                        label: <Link href={`/suggestion/dm`}>Предложение</Link>,
                    },
                    {
                        key: "1-10-4",
                ...
                children: [
                    {
                        key: "1-11-1",
                        label: (
                            <Link href={`/information/dpop`}>Информация</Link>
                        ),
                    },
                    {
                        key: "1-11-2",
                    ...
                    },
                    {
                        key: "1-11-3",
                        label: (
                            <Link href={`/suggestion/dpop`}>Предложение</Link>
                        ),
                    },
                    {
                        key: "1-11-4",
...
export default function Sidebar() {
    return <Menu mode="inline" items={items} className="text-black" />;
}
